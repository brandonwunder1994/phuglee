      ...
      if (ocr && ocr.text) {
        ...
        if (fromOcrParsed) {
          ...
          if (
            ...
            // Always surface OCR honesty fields (truncation, pages, rotation)
            fromOcrParsed.ocrTruncated = Boolean(ocr.ocrTruncated);
            fromOcrParsed.ocrMaxPages = ocr.ocrMaxPages;
            fromOcrParsed.ocrTotalPages = ocr.ocrTotalPages;
            fromOcrParsed.ocrPageCapNote = ocr.ocrPageCapNote || null;
            if (ocr.rotatedBy != null) fromOcrParsed.rotatedBy = ocr.rotatedBy;
