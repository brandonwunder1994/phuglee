...
const CATEGORY_HEADER_RE =
  /\b(cat|category|type|vio|violation|issue|offense|charge|ordinance|complaint|problem|infraction|code\s*type|case\s*type|action\s*form|form\s*name|form\s*type|request\s*type)\b/i;
