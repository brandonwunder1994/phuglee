...
async function requestAmendmentSend(dealId, input = {}, actor = '') {
  ...
  const originalAgreementDate = slugPart(
    input.originalAgreementDate || defaults.originalAgreementDate
  );
  ...
  const patchFields = {};
  if (originalAgreementDate && !existing.originalAgreementDate) {
    patchFields.originalAgreementDate = originalAgreementDate;
  }
