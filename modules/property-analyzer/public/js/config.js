...
// Sized for ~5 Keep/sec with Undo: ~40 leads of runway + fat concurrent downloads.
R.REVIEW_PREFETCH_AHEAD = 48;
R.REVIEW_PREFETCH_URGENT = 24;
R.REVIEW_PRELOAD_CONCURRENCY = 12;
R.REVIEW_PRELOAD_CACHE_MAX = 512;
