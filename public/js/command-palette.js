(function () {
  ...
  var COMMANDS = [
    ...
    { group: 'Navigate', label: 'Home Vault', href: '/vault', meta: 'Curated house leads · Max plan' },
    { group: 'Navigate', label: 'Land Vault', href: '/land-vault', meta: 'Vacant lots · Land Desk · Max plan' },
