...
- [x] **IDLE-02**: Upload step makes **Process** the visual climax (dropzone stage + one fire CTA); response date is tight meta, not a peer form block
...
- [x] **KILL-03**: Primary post-scrub CTA for operators remains **Save list / Stage** (Analyze boundary preserved); Preview CSV stays secondary
...
- [x] **SHIFT-01**: Operators can run a **multi-city shift**: sticky queue/inventory of staged cities/lists; after save, next city is one-click without re-teaching chrome / full wizard restart feel
