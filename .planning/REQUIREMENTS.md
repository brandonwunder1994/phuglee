...
- [x] **COL-03**: v1.7 `promoteCategoryFromRaw` runs only after scorer/confirm path and only when mapped Type cell is still empty; promote must not override a chosen Type column
